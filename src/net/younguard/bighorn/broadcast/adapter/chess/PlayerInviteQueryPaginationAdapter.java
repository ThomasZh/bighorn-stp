...
public class PlayerInviteQueryPaginationAdapter
		extends RequestCommand
{
	public PlayerInviteQueryPaginationAdapter()
	{
		super();
	...
	{
		reqCmd = (PlayerInviteQueryPaginationReq) new PlayerInviteQueryPaginationReq().decode(tlv);
			...
			throws Exception
	{
		...
		try {
			...
			PlayerInviteQueryPaginationResp respCmd = new PlayerInviteQueryPaginationResp(this.getSequence(),
	...
	private PlayerInviteQueryPaginationReq reqCmd;

	private final static Logger logger = LoggerFactory.getLogger(PlayerInviteQueryPaginationAdapter.class);
